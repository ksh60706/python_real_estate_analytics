# ======================================================================================
# Program Name          :       collect_efficiency_apartment_rent.py
# Date                  :       30-Aug-2020
# Version               :       1.0
# Author                :       SOO-HWAN, KIM (SH)
# Description           :       오피스텔 전월세 신고정보 자료 다운 (국토교통부 API)
# REFERENCE
# ======================================================================================
...
# URL 정의
TARGET_URL_ENDPOINT = "http://openapi.molit.go.kr/OpenAPI_ToolInstallPackage/service/rest/RTMSOBJSvc/getRTMSDataSvcOffiRent"
