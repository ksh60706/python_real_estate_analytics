# ======================================================================================
# Program Name          :       collect_apartment_rent_data.py
# Date                  :       03-Sep-2020
# Version               :       1.0
# Author                :       SOO-HWAN, KIM (SH)
# Description           :       아파트 전월세 신고정보 자료 다운 (국토교통부 API)
# REFERENCE
# ======================================================================================
# \reference\PDF\아파트_전월세_신고정보_조회_기술문서(ApartmentRentData).pdf
# \reference\HWP\아파트 전월세 신고정보 조회 기술문서.hwp
# ======================================================================================
#
# Revision History
# ======================================================================================
...
# 변수 정의
CSV_FILE_PATH = "../reference/FILE/아파트전월세"
FIELD_NAMES = ['API_URL', '건축년도', '년', '법정동', '보증금액', '아파트', '월', '월세금액', '일', '전용면적', '지번', '지역코드', '층']
ERROR_LIST_TXT_PATH = os.path.dirname(os.path.abspath(os.path.dirname(__file__)))+"\\reference\ERROR\\collect_apartment_rent_data.txt"
...
# URL 정의
TARGET_URL_ENDPOINT = "http://openapi.molit.go.kr:8081/OpenAPI_ToolInstallPackage/service/rest/RTMSOBJSvc/getRTMSDataSvcAptRent"
